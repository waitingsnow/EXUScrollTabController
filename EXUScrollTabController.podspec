#
#  Be sure to run `pod spec lint EXUScrollTabController.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.author             = { "guangwei" => "GuangweiDream@gmail.com" }
  # Or just: s.author    = "guangwei"
  # s.authors            = { "guangwei" => "GuangweiDream@gmail.com" }
  # s.social_media_url   = "http://twitter.com/guangwei"
  ...
  s.source       = { :git => "https://github.com/waitingsnow/EXUScrollTabController.git", :tag => "#{s.version}" }
